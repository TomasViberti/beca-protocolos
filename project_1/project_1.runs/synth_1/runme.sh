...
HD_PWD='D:/Beca/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_microblaze.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_microblaze.tcl
