...
HD_PWD='D:/Beca/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_microblaze.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_microblaze.tcl -notrace
